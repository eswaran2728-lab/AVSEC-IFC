  ...
  return (
    <main className="dark relative flex min-h-screen flex-col overflow-hidden bg-background">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="animate-float-slow animate-glow-pulse absolute -left-32 -top-32 h-[26rem] w-[26rem] rounded-full bg-icms-brand/25 blur-[120px]" />
        <div
      ...
      <div className="relative z-10 flex flex-1 flex-col p-4 sm:p-6">
        <div className="flex flex-1 items-center justify-center py-8">
          <div className="w-full max-w-sm space-y-6">
            ...
            >
              New staff member?{" "}
              <Link href="/icms/register" className="font-medium text-primary underline underline-offset-4">
                Register here
              </Link>
            </p>
          </div>
