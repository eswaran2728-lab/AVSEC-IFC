  ...
  return (
    <main className="dark relative flex min-h-screen flex-col overflow-hidden bg-background">
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -right-24 h-[30rem] w-[30rem] rounded-full bg-icms-brand/20 blur-[140px]" />
      </div>
        ...
        <div className="flex flex-1 items-center justify-center py-8">
          <div className="w-full max-w-sm space-y-6">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/icms/login" className="font-medium text-primary underline underline-offset-4">
                Sign in
              </Link>
            </p>
          </div>
