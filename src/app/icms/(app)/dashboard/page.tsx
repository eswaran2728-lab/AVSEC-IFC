...
import { createClient } from "@/lib/icms/supabase/server";
    ...
    <div className="space-y-6">
      ...
      {checkpointQueue ? (
        <Link href="/icms/scan" className="animate-scale-in block">
          <Card className="animate-gradient-pan relative overflow-hidden border-none bg-[linear-gradient(110deg,hsl(var(--icms-brand)),hsl(var(--primary)),hsl(var(--icms-brand)))] text-white shadow-lg shadow-icms-brand/20 transition-transform hover:-translate-y-0.5">
            <div
              aria-hidden
